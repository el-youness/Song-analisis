...
- Cleaning the dataset: remove pronouns and determiners from lyrics ...
- Statistical analysis of the dataset: wordcount ...
- Sentiment analysis: group the songs by sentiment using the words
